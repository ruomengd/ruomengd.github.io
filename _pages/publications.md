...
* <font color="grey">The ImDiffusion framework combines imputation and diffusion models to achieve accurate and robust anomaly detection in multivariate time series data. It outperforms existing approaches by leveraging neighboring values and capturing complex dependencies. ImDiffusion has been integrated into Microsoft's production system. [[paper]](https://arxiv.org/pdf/2307.00754.pdf) [[code]](https://github.com/17000cyh/IMDiffusion)</font> 
